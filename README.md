# проект почти завершен. Но нет модалок. Их мб придется делать не мне. Парочка блоков реализовано не мной. Баллы получены без каких-либо оптимизаций (нет webp, minify и прочего)
